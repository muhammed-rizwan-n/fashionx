      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div>
          ...
          <p class="mt-6 text-neutral-600">
            This product blends contemporary tailoring with timeless fabrics.
          ...
          <div class="mt-6 flex items-center gap-3">
            ...
            <input
              ...
              min="1"
              value="1"
              class="w-20 rounded-md border border-neutral-200 px-3 py-2 text-sm"
            />
          </div>

          <div class="mt-6 flex gap-3">
            <button
              class="rounded-md bg-gradient-to-r from-brand-500 to-accent px-6 py-3 text-white font-medium"
              (click)="addToCart()"
            >
              Add to cart
            </button>
            <button class="rounded-md border border-neutral-300 px-4 py-3">
              Wishlist
            </button>
          </div>
          ...
          <div class="mt-10 text-sm text-neutral-600">
            ...
            <p class="mt-2">
              High quality fabric, soft touch, machine washable.
            </p>
          </div>
        </div>
      </div>
