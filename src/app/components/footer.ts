  ...
  template: `
    <footer class="border-t border-neutral-200 bg-neutral-50">
      <div class="container px-4 py-16">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8 text-sm">
          <div>
            ...
            <p class="text-neutral-600">
              Modern essentials crafted with care. Sign up for early access to
              drops.
            </p>
          </div>
          <div>
          ...
          <div>
            ...
            <p class="mt-3 text-neutral-600">
              Subscribe for style updates and exclusive drops.
            </p>
            <form class="mt-3 flex gap-2">
              <input
                ...
                class="w-full rounded-md border border-neutral-300 px-3 py-2 text-sm outline-none focus:ring-2 focus:ring-neutral-900"
              />
              <button
        ...
        <div
          class="mt-10 border-t border-neutral-200 pt-6 flex flex-col md:flex-row items-center justify-between text-xs text-neutral-500"
        >
          <div class="mb-3 md:mb-0">
            © {{ year }} fashionx. All rights reserved.
          </div>
