    ...
    <div class="group relative card">
      ...
      >
        <div class="relative aspect-[4/5] bg-neutral-100">
          ...
          />
          <div
            class="absolute left-3 top-3 rounded-full bg-white px-2 py-1 text-xs font-medium"
          >
            New
          </div>
        </div>
      ...
      <div class="p-4">
        <h3
          class="text-sm md:text-base font-medium text-neutral-900 line-clamp-2"
        >
          {{ product.title }}
        </h3>
        <div class="mt-2 flex items-baseline justify-between">
          ...
          <div
            *ngIf="product.compareAtPrice"
            class="text-xs text-neutral-500 line-through"
          >
        ...
        <div class="mt-3 flex gap-2">
          <button
            (click)="addToCart()"
            class="flex-1 rounded-md bg-neutral-900 px-3 py-2 text-sm text-white hover:bg-neutral-800"
          >
            Add to cart
          </button>
          <button
