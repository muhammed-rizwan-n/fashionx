...
@Component({
  ...
  template: `
    ...
    >
      <button class="px-3 py-2 hover:text-neutral-900 font-medium">
        Collections
      </button>
      <div
        ...
        <div class="grid grid-cols-3 gap-4">
          <a
            *ngFor="let c of collections"
            ...
            class="flex items-center gap-3 p-2 hover:bg-neutral-50 rounded"
          >
            <div
              class="h-14 w-20 bg-cover bg-center rounded"
...
export class CollectionDropdownComponent {
  @Input({ required: true }) collections: {
    handle: string;
    title: string;
    image?: string;
  }[] = [];
